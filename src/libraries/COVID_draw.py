...
async def DrawPicByQueryCity(city, subName: Optional[str], curPage: Optional[int] = 1):
    res, success = await get_level_list(city['city_name'])
    if success == 555:
        # 请求过于频繁，请三分钟后
        return NULL, 555
    subList = res['sub_list']
    ...
    baseDraw.text((12, imgH-50), footer, 'black', font)
